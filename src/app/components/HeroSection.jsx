      ...
      <div className="grid grid-cols-1 sm:grid-cols-12 gap-8">
        ...
        >
          ...
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            Innovative developer skilled in React and Next.js, dedicated to crafting high-performance web solutions that enhance user experience and drive business growth.
          </p>
          <div>
            <Link
              href="/#projects"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-slate-200 text-white transition-all duration-300"
            >
              My Projects
            </Link>
            <Link
